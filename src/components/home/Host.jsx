...
<div className="absolute font-rufina max-xl:w-1/2 max-2xl:w-1/2 w-1/3 max-lg:w-1/2  max-md:w-2/3 max-sm:w-4/5 bg-white flex flex-col items-center py-10 rounded-lg px-3 top-[30%] max-xl:left-[25%] max-lg:left-[25%] max-md:left-[18%] max-sm:left-[10%] max-2xl:left-[25%]   left-[32%]   opacity-85 ">
